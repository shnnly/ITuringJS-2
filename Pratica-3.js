...
console.log('Valor sem gorjeta')
for (let i = 1; i <= 100; i++) {
    console.log(receita[i].valor)
    }

/*console.log('Valor incluindo gorjeta')
for (let i = 1; i <= 100; i++) {
    console.log(receita[i].valor*gorjeta)
    }*/

console.log('Valor abaixo de 50 reais')
for (let i = 1; i <= 100; i++) {
    console.log(receita[i].valor <= 50)
    }
